...
<html lang="en">
<head>
    <title>Code coverage report for src/server/osc/msg.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/server/osc</a> msg.js
    </h1>
    <div class='clearfix'>
...
1166
1167
1168</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export function groupNew(
  ...
  return [
    '/g_new',
    nodeID,
    _.isUndefined(addAction) ? <span class="branch-0 cbranch-no" title="branch not covered" >AddActions.HEAD </span>: addAction,
    targetID || 0
  ];
}
&nbsp;
