...
<html lang="en">
<head>
    <title>Code coverage report for src/server/internals/SendOSC.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/server/internals</a> SendOSC.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >  ms</span>g(message: MsgType) {
<span class="cstat-no" title="statement not covered" >    this.emit('msg', makeMessage(message));</span>
  }
&nbsp;
  /**
  * bundle
  ...
  */
<span class="fstat-no" title="function not covered" >  bu</span>ndle(time: OSCTimeType, packets: [MsgType]) {
<span class="cstat-no" title="statement not covered" >    if (typeof time === 'number' &amp;&amp; time &lt; 10000) {</span>
<span class="cstat-no" title="statement not covered" >      time = deltaTimeTag(time);</span>
    }
<span class="cstat-no" title="statement not covered" >    this.emit('bundle', makeBundle(time, packets));</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  de</span>ltaTimeTag(delta: number, now: ?Date): [number] {
<span class="cstat-no" title="statement not covered" >    return deltaTimeTag(delta, now);</span>
  }
&nbsp;
  /**
  ...
  subscribe(
    ...
    var msgs = Observable.fromEvent(this, 'msg', <span class="fstat-no" title="function not covered" >ms</span>g =&gt; {
<span class="cstat-no" title="statement not covered" >      return {</span>
        type: 'msg',
        payload: msg
      };
    });
    var bundles = Observable.fromEvent(this, 'bundle', <span class="fstat-no" title="function not covered" >bu</span>ndle =&gt; {
<span class="cstat-no" title="statement not covered" >      return {</span>
        type: 'bundle',
        payload: bundle
      };
