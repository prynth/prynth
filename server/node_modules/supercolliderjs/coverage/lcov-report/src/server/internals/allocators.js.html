...
<html lang="en">
<head>
    <title>Code coverage report for src/server/internals/allocators.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/server/internals</a> allocators.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.62% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>82/84</span>
      </div>
      <div class='fl pad1y space-right2'>
...
export function allocBlock(
  ...
  keys.forEach(sizeKey =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (size &gt;= blockSize) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (enc === NOT_FOUND) {
<span class="cstat-no" title="statement not covered" >    throw Error('Block is already allocated', addr, blockSize, state);</span>
  }
&nbsp;
...
function findEnclosingFreeBlock(
  ...
  state.forEach((blks, sizeKey) =&gt; {
    ...
    blks.forEach(fblock =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (blockEncloses(addr, blockSize, fblock, freeBlockSize)) {
...
function popFreeBlock(
  ...
  return state.update(
    String(blockSize),
    blks =&gt; blks ? blks.filter(x =&gt; x !== addr) : <span class="branch-1 cbranch-no" title="branch not covered" >blks</span>
  );
}
&nbsp;
/**
...
function splitFreeBlock(
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (topGap &gt; 0 &amp;&amp; bottomGap &gt; 0) {
