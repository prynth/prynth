...
<html lang="en">
<head>
    <title>Code coverage report for server/ServerState.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">server</a> ServerState.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  constructor(server, store) {
    this.server = server;
    this.store = store ? <span class="branch-0 cbranch-no" title="branch not covered" >store </span>: new Store();
    this.resetState();
...
&nbsp;
   ...
   */
  allocAudioBus(numChannels=<span class="branch-0 cbranch-no" title="branch not covered" >1)</span> {
...
&nbsp;
   ...
   * @returns {int} numChannels
   */
  allocControlBus(numChannels=<span class="branch-0 cbranch-no" title="branch not covered" >1)</span> {
...
&nbsp;
   ...
   * @param {int} numChannels
   */
<span class="fstat-no" title="function not covered" >  fr</span>eeControlBus(index, numChannels) {
<span class="cstat-no" title="statement not covered" >    this._freeBlock(StateKeys.CONTROL_BUSSES, index, numChannels);</span>
  }
&nbsp;
  /**
   ...
   */
  allocBufferID(numConsecutive=<span class="branch-0 cbranch-no" title="branch not covered" >1)</span> {
...
&nbsp;
  ...
  _keys(more=<span class="branch-0 cbranch-no" title="branch not covered" >[])</span> {
