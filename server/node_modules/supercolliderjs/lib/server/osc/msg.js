...
exports.AddActions = undefined;
exports.quit = quit;
exports.notify = notify;
exports.status = status;
exports.cmd = cmd;
exports.dumpOSC = dumpOSC;
exports.sync = sync;
exports.clearSched = clearSched;
exports.error = error;
exports.defRecv = defRecv;
exports.defLoad = defLoad;
exports.defLoadDir = defLoadDir;
exports.defFree = defFree;
exports.nodeFree = nodeFree;
exports.nodeRun = nodeRun;
exports.nodeSet = nodeSet;
exports.nodeSetn = nodeSetn;
exports.nodeFill = nodeFill;
exports.nodeMap = nodeMap;
exports.nodeMapn = nodeMapn;
exports.nodeMapAudio = nodeMapAudio;
exports.nodeMapAudion = nodeMapAudion;
exports.nodeBefore = nodeBefore;
exports.nodeAfter = nodeAfter;
exports.nodeQuery = nodeQuery;
exports.nodeTrace = nodeTrace;
exports.nodeOrder = nodeOrder;
exports.synthNew = synthNew;
exports.synthGet = synthGet;
exports.synthGetn = synthGetn;
exports.synthNoid = synthNoid;
exports.groupNew = groupNew;
exports.parallelGroupNew = parallelGroupNew;
exports.groupHead = groupHead;
exports.groupTail = groupTail;
exports.groupFreeAll = groupFreeAll;
exports.groupDeepFree = groupDeepFree;
exports.groupDumpTree = groupDumpTree;
exports.groupQueryTree = groupQueryTree;
exports.ugenCmd = ugenCmd;
exports.bufferAlloc = bufferAlloc;
exports.bufferAllocRead = bufferAllocRead;
exports.bufferAllocReadChannel = bufferAllocReadChannel;
exports.bufferRead = bufferRead;
exports.bufferReadChannel = bufferReadChannel;
exports.bufferWrite = bufferWrite;
exports.bufferFree = bufferFree;
exports.bufferZero = bufferZero;
exports.bufferSet = bufferSet;
exports.bufferSetn = bufferSetn;
exports.bufferFill = bufferFill;
exports.bufferGen = bufferGen;
exports.bufferClose = bufferClose;
exports.bufferQuery = bufferQuery;
exports.bufferGet = bufferGet;
exports.bufferGetn = bufferGetn;
exports.controlBusSet = controlBusSet;
exports.controlBusSetn = controlBusSetn;
exports.controlBusFill = controlBusFill;
exports.controlBusGet = controlBusGet;
exports.controlBusGetn = controlBusGetn;
exports.nonRealTimeEnd = nonRealTimeEnd;
...
/**
  ...
  * @module msg
  */
var AddActions = exports.AddActions = {
  HEAD: 0,
  TAIL: 1,
  BEFORE: 2,
  AFTER: 3,
...
function flattenPairs(pairs) {
  return _lodash2.default.flatten(_lodash2.default.isObject(pairs) ? _lodash2.default.toPairs(pairs) : pairs);
}
...
/**
  ...
  */
function notify() {
  var on = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
...
/**
  ...
  *
  */
function defRecv(buffer) {
  var completionMsg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function nodeRun(nodeID) {
  var on = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
/**
  ...
  * @return {Array} - OSC message
  */
function nodeSetn(nodeID) {
  var valueSets = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  return ['/n_setn', nodeID].concat(_lodash2.default.flatten(valueSets));
}
...
function nodeFill(nodeID) {
  var triples = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  return ['/n_fill', nodeID].concat(_lodash2.default.flatten(triples));
}
...
/**
  ...
  */
function nodeMapn(nodeID) {
  var triples = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  return ['/n_mapn', nodeID].concat(_lodash2.default.flatten(triples));
}
 ...
 * Takes a list of pairs of control names or indices and audio bus indices and causes those controls to be read continuously from a global audio bus. If the node is a group, then it maps the controls of every node in the group. If the audio bus index is -1 then any current mapping is undone. Any n_set, n_setn and n_fill command will also unmap the control. For the full audio rate signal, the argument must have its rate set to \ar.
  ...
  * @return {Array} - OSC message
  */
function nodeMapAudio(nodeID, pairs) {
...
/**
  ...
  */
function nodeMapAudion(nodeID) {
  var triples = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

  return ['/n_mapan', nodeID].concat(_lodash2.default.flatten(triples));
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function nodeBefore(moveNodeID, beforeNodeID) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function nodeAfter(moveNodeID, afterNodeID) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function nodeOrder(addAction, targetID, nodeIDs) {
...
/**
  ...
  * @return OSC message
  */
function synthNew(defName) {
  var nodeID = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
  var addAction = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : AddActions.TAIL;
  var targetID = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
...
/**
  ...
  */
function synthGet(synthID, controlNames) {
  return {
...
/**
  ...
  */
function synthGetn(synthID, controlName, n) {
  return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupNew(nodeID) {
  var addAction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : AddActions.HEAD;
  var targetID = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

  return ['/g_new', nodeID, _lodash2.default.isUndefined(addAction) ? AddActions.HEAD : addAction, targetID || 0];
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function parallelGroupNew(groupID) {
  var addAction = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : AddActions.HEAD;
  var targetID = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupHead(groupID, nodeID) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupTail(groupID, nodeID) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupDeepFree(groupID) {
...
/**
  ...
  *
  */
function groupDumpTree(groupID) {
  var dumpControlValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
/**
  ...
  * @return {Array} - OSC message
  */
function groupQueryTree(groupID) {
  var dumpControlValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
/**
  ...
  * @return {Array} - OSC message
  */
function ugenCmd(nodeID, uGenIndex, command) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferAlloc(bufferID, numFrames, numChannels) {
  var completionMsg = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferAllocRead(bufferID, path) {
  ...
  var completionMsg = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferAllocReadChannel(bufferID, path, startFrame, numFramesToRead, channels) {
  var completionMsg = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferRead(bufferID, path) {
  var startFrame = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  var numFramesToRead = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : -1;
  var startFrameInBuffer = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
  var leaveFileOpen = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;
  var completionMsg = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferReadChannel(bufferID, path) {
  var startFrame = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  var numFramesToRead = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : -1;
  var startFrameInBuffer = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 0;
  var leaveFileOpen = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;
  var channels = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : [];
  var completionMsg = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferWrite(bufferID, path) {
  var headerFormat = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'aiff';
  var sampleFormat = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'float';
  var numFramesToWrite = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : -1;
  var startFrameInBuffer = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 0;
  var leaveFileOpen = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 0;
  var completionMsg = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : null;
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferSet(bufferID, pairs) {
  return ['/b_set', bufferID].concat(_lodash2.default.flatten(pairs));
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferSetn(bufferID, startFrame) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferFill(bufferID, startFrame, numFrames, value) {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferGen(bufferID, command) {
...
/**
  ...
  */
function bufferGet(bufferID, framesArray) {
  return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function bufferGetn(bufferID, startFrame, numFrames) {
  return {
...
/**
  ...
  * @return {Array} - OSC message
  */
function controlBusSet(pairs) {
  return ['/c_set'].concat(_lodash2.default.flatten(pairs));
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function controlBusSetn() {
  var triples = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

  return ['/c_setn'].concat(_lodash2.default.flatten(triples));
}
...
/**
  ...
  * @return {Array} - OSC message
  */
function controlBusFill() {
  var triples = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

  return ['/c_fill'].concat(_lodash2.default.flatten(triples));
}
...
/**
  ...
  */
function controlBusGetn(startBusIndex, numBusses) {
  return {
