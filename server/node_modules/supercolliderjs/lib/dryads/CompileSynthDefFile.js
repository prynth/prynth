...
var CompileSynthDefFile = function (_Dryad) {
  _inherits(CompileSynthDefFile, _Dryad);

  function CompileSynthDefFile(synthDefPath) {
    var children = arguments.length <= 1 || arguments[1] === undefined ? [] : arguments[1];

    _classCallCheck(this, CompileSynthDefFile);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CompileSynthDefFile).call(this, { path: synthDefPath }, children));
  }

  _createClass(CompileSynthDefFile, [{
    key: 'requireParent',
    ...
    value: function prepareForAdd() {
      ...
      // execute file
      var fullpath = _path2.default.resolve(this.properties.path);
      var defName = _path2.default.basename(fullpath, _path2.default.extname(fullpath));

      return {
        buffer: function buffer(context) {
          return new Promise(function (resolve, reject) {
            _fs2.default.readFile(fullpath, function (err, sourceCode) {
              if (err) {
                reject(err);
              } else {
  ...
  return CompileSynthDefFile;
}(_dryadic.Dryad);

// temp


exports.default = CompileSynthDefFile;
var StateKeys = {
...
//# sourceMappingURL=CompileSynthDefFile.js.map