...
var CompileSynthDef = function (_Dryad) {
  _inherits(CompileSynthDef, _Dryad);

  function CompileSynthDef(defName, sourceCode) {
    var children = arguments.length <= 2 || arguments[2] === undefined ? [] : arguments[2];

    _classCallCheck(this, CompileSynthDef);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(CompileSynthDef).call(this, { defName: defName, sourceCode: sourceCode }, children));
  }

  _createClass(CompileSynthDef, [{
    key: 'requireParent',
  ...
  return CompileSynthDef;
}(_Dryad3.default);

// temp


exports.default = CompileSynthDef;
var StateKeys = {
...
//# sourceMappingURL=CompileSynthDef.js.map