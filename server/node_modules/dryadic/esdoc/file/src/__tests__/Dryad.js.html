...
<head>
  ...
  <title data-ice="title">src/__tests__/Dryad.js | API Document</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">src/__tests__/Dryad.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">jest.dontMock(&apos;../Dryad&apos;);
