...
<html lang="en">
<head>
    <title>Code coverage report for dryadic/src/updateContext.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dryadic/src</a> updateContext.js
    </h1>
    <div class='clearfix'>
...
export default function updateContext(
  ...
  if (command.updateContext) {
    let uc: Object = isFunction(command.updateContext)
      ...
      : <span class="branch-1 cbranch-no" title="branch not covered" >command.updateContext;</span>
...
function resolveValues(object: Object): Promise&lt;Object&gt; {
  ...
  return Promise.map(ks, key =&gt; {
    ...
    return Promise.resolve(isPlainObject(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >resolveValues(value) </span>: value);
  }).then(values =&gt; {
    let result = {};
    ks.forEach((key, i) =&gt; {
      result[key] = values[i];
