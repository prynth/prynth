...
<html lang="en">
<head>
    <title>Code coverage report for dryadic/src/utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dryadic/src</a> utils.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    throw new Error(`Invalid type: ${typeof properties}`);</span>
  }
&nbsp;
  forEach(properties, (value: any, key: string) =&gt; {
    if (isArray(value)) {
      result[key] = value.map((v, i) =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (isObject(v)) {
<span class="cstat-no" title="statement not covered" >          return mapProperties(v, fn, appendKey(_prefixKeys, `${key}.${i}`));</span>
        } else {
          return v;
        }
      });
