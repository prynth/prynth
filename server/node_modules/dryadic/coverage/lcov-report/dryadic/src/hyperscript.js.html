...
<html lang="en">
<head>
    <title>Code coverage report for dryadic/src/hyperscript.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dryadic/src</a> hyperscript.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!isArray(root)) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(isString(tag) || tag.isDryadSubclass)) {
<span class="cstat-no" title="statement not covered" >    die(root, 'Expected tag to be string');</span>
  }
&nbsp;
  if (children) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isObject(properties)) {
<span class="cstat-no" title="statement not covered" >      die(root, 'Expected properties to be an Object');</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isArray(children)) {
<span class="cstat-no" title="statement not covered" >      die(root, 'Expected children to be an Array');</span>
    ...
    if (isArray(properties)) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (properties &amp;&amp; !isObject(properties)) {
<span class="cstat-no" title="statement not covered" >        die(root, 'Expected properties to be an Object');</span>
      }
    }
  }
...
&nbsp;
function <span class="fstat-no" title="function not covered" >die(</span>root: any, message: string) {
