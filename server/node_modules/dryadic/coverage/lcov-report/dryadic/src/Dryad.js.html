...
<html lang="en">
<head>
    <title>Code coverage report for dryadic/src/Dryad.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">dryadic/src</a> Dryad.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  constructor(properties: Object = {}, children: Array&lt;Dryad&gt; = []) {
    this.properties = assign({}, this.defaultProperties(), properties || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
    this.children = children || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   * @returns {Boolean}
   */
<span class="fstat-no" title="function not covered" >  st</span>atic isDryadSubclass(): boolean {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  va</span>lue(/*context:Object*/): any {
