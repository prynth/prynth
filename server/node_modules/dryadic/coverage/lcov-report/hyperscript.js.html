...
<html lang="en">
<head>
    <title>Code coverage report for hyperscript.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> hyperscript.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    die(root, 'Got null|undefined.');</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isArray(root)) {
<span class="cstat-no" title="statement not covered" >    die(root, 'Expected Array.');</span>
  }
&nbsp;
  let [tag, properties, children] = root;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!tag) {
<span class="cstat-no" title="statement not covered" >    die(root, 'Null tag');</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(_.isString(tag) || tag.isDryadSubclass)) {
<span class="cstat-no" title="statement not covered" >    die(root, 'Expected tag to be string');</span>
  }
&nbsp;
  if (children) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isObject(properties)) {
<span class="cstat-no" title="statement not covered" >      die(root, 'Expected properties to be an Object');</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isArray(children)) {
<span class="cstat-no" title="statement not covered" >      die(root, 'Expected children to be an Array');</span>
    }
  } else {
    ...
    if (_.isArray(properties)) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (properties &amp;&amp; (!_.isObject(properties))) {
<span class="cstat-no" title="statement not covered" >        die(root, 'Expected properties to be an Object');</span>
      }
    }
  }
...
&nbsp;
&nbsp;
function <span class="fstat-no" title="function not covered" >die(</span>root, message) {
<span class="cstat-no" title="statement not covered" >  throw new Error(`Bad argument to hyperscript: [${typeof root}] ${root} ${message}`);</span>
}
&nbsp;</pre></td></tr>
</table></pre>
