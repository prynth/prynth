...
<html lang="en">
<head>
    <title>Code coverage report for CommandNode.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> CommandNode.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(
    ...
    properties: Object,
    id: string,
    children: Array&lt;CommandNode&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >[]</span>
  ) {
...
&nbsp;
  callFuncs(): Object {
    return mapProperties(
      this.properties,
      (value: any): any =&gt; (isFunction(value) ? <span class="branch-0 cbranch-no" title="branch not covered" >value(this.context) </span>: value)
    );
  }
&nbsp;
  /**
