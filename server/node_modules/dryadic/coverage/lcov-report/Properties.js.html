...
<html lang="en">
<head>
    <title>Code coverage report for Properties.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> Properties.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  prepareForAdd() {
    console.log('Properties returns callOrder', PROPERTIES_MODE);
    return {
...
&nbsp;
      return (context:Object) : any =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!context.propertiesValues) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Missing propertiesValues from context ${context.id}`);</span>
        }
...
function cloneValue(value:any) : any {
  return isDryad(value) ? value.clone() : <span class="branch-1 cbranch-no" title="branch not covered" >_.clone(value);</span>
}
&nbsp;</pre></td></tr>
</table></pre>
